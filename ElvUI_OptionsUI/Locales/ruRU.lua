...
L["Change the width and controls how big of an area on the screen will accept clicks to target unit."] = "Измените ширину и контролируйте, насколько большая область на экране будет принимать клики для цели."
...
L["Colorize Selected Text"] = "Окрасить выделенный текст"
...
L["Equipped Item"] = "Экипированный предмет"
...
L["If enabled then the filter will activate if the unit is channeling anything."] = "Если включено, то фильтр активируется, если юнит что-то направляет."
...
L["If enabled then the filter will activate if the unit is not channeling anything."] = "Если включено, то фильтр активируется, если юнит ничего не направляет."
...
L["Pick Up Action Key"] = "Поднять ключ действия"
...
L["Reverse Cooldown"] = "Обратное время восстановления"
...
L["Show Quest Icon"] = "Показать иконку квеста"
...
L["Transparent Backdrops"] = "Прозрачность фонов"
L["Transparent Buttons"] = "Прозрачность кнопок"
...
L["World State Frame"] = "Окно статуса сервера"
