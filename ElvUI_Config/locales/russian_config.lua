...
L["Color of the actionbutton when out of power (Mana, Rage)."] = "Цвет кнопок на панелях команд, когда не хватает ресурса (маны, яроски)";
...
L["Minutes"] = "Минуты";
L["Mouse Over"] = "При наведении";  -- Так же используется в Сумки
...
--Media
L["Applies the font and font size settings throughout the entire user interface. Note: Some font size settings will be skipped due to them having a smaller font size by default."] = "Пименить этот шрифт ко всем элементам интерфейса. Некоторые шрифты будут попущены из-за более мелкого размера по умолчанию.";
L["Applies the primary texture to all statusbars."] = "Пименяет основную текстуу ко всем полосам состояния.";
