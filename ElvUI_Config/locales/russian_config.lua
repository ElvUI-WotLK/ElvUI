...
L["Color of a nameplate that is tagged by another person."] = 'Цвет индикатора юнита, "принадлежащего" дргому игроку'
L['Color on low health'] = "Цвет";
L["Color Tanked/Loose"] = "Окрашивать танкуемых/свободных"
...
L["Depending on your role. If you are a tank then it will color mobs being tanked by the offtank. If you are not a tank then it will color mobs not being tanked. This is not 100% accurate and should only be used as a referance."] = "Зависит от роли. Если Вы танк, то будут окрашиваться мобы, танкуемые вторым танком. Если Вы не танк, то окрашиваться будут мобы, которых НЕ танкуют. Это не на 100% точно и должно восприниматься только как рекомендация"
L["Depending on your role. If you are a tank then its the color of mobs being tanked not by you by an actual tank. If you are not a tank then it is the color of mobs that are not currently being tanked."] = "Зависит от роли. Если Вы танк, то это цвет мобов, танкуемых вторым танком. Если Вы не танк, то это цвет мобов, которых НЕ танкуют."
...
L['Name Alignment'] = "Выравнивание имени"
L["Name X-Offset"] = "Смещение имени по Х"
...
L["Tagged Color"] = "Занятый"
L['Tagged NPC'] = 'Чужой НИП';
L["Tanked/Loose Color"] = "Цвет танкуемых/свободных"
