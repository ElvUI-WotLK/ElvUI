...
E.PopupDialogs["ELVUI_UPDATE_AVAILABLE"] = {
	text = L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/sirus-addons/ElvUI/"],
	hasEditBox = 1,
	OnShow = function(self)
		self.editBox:SetAutoFocus(false);
		self.editBox.width = self.editBox:GetWidth();
		self.editBox:SetWidth(220);
		self.editBox:SetText("https://github.com/sirus-addons/ElvUI");
	...
	EditBoxOnTextChanged = function(self)
		if(self:GetText() ~= "https://github.com/sirus-addons/ElvUI") then
			self:SetText("https://github.com/sirus-addons/ElvUI");
		end
		self:HighlightText();
		self:ClearFocus();
		ChatEdit_FocusActiveWindow();
