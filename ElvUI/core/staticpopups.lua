...
E.PopupDialogs['TUKUI_ELVUI_INCOMPATIBLE'] = { -- Найден :)
...
E.PopupDialogs['DISABLE_INCOMPATIBLE_ADDON'] = { -- Найден :)
...
E.PopupDialogs['INCOMPATIBLE_ADDON'] = { -- Найден :)
...
E.PopupDialogs['PIXELPERFECT_CHANGED'] = { -- Найден :)
...
E.PopupDialogs['FAILED_UISCALE'] = { -- Найден :)
...
E.PopupDialogs["CONFIG_RL"] = { -- Найден :)
...
E.PopupDialogs["GLOBAL_RL"] = { -- Найден :)
...
E.PopupDialogs["PRIVATE_RL"] = { -- Найден :)
...
E.PopupDialogs["KEYBIND_MODE"] = { -- Найден :)
...
E.PopupDialogs["DELETE_GRAYS"] = { -- Найден :)
...
E.PopupDialogs["BUY_BANK_SLOT"] = { -- Найден :)
...
E.PopupDialogs["CANNOT_BUY_BANK_SLOT"] = { -- Найден :)
...
E.PopupDialogs["NO_BANK_BAGS"] = { -- Найден :)
...
E.PopupDialogs["RESETUI_CHECK"] = { -- Найден :)
