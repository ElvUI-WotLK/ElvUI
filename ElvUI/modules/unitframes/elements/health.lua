...
function UF:Configure_HealthBar(frame)
	...
	if(frame.ORIENTATION == "LEFT") then
		health:Point("TOPRIGHT", frame, "TOPRIGHT", -frame.BORDER - frame.POWERBAR_OFFSET, -frame.BORDER - frame.CLASSBAR_YOFFSET);
		...
		elseif(frame.USE_POWERBAR_OFFSET) then
			health:Point("TOPRIGHT", frame, "TOPRIGHT", -frame.BORDER+frame.POWERBAR_OFFSET, -frame.BORDER - frame.CLASSBAR_YOFFSET);
			health:Point("BOTTOMLEFT", frame, "BOTTOMLEFT", frame.PORTRAIT_WIDTH + frame.BORDER, frame.BORDER+frame.POWERBAR_OFFSET);
		elseif(frame.USE_INSET_POWERBAR) then
			health:Point("BOTTOMLEFT", frame, "BOTTOMLEFT", frame.PORTRAIT_WIDTH + frame.BORDER, frame.BORDER);
		elseif(frame.USE_MINI_POWERBAR) then
			health:Point("BOTTOMLEFT", frame, "BOTTOMLEFT", frame.PORTRAIT_WIDTH + frame.BORDER, frame.BORDER + (frame.POWERBAR_HEIGHT/2));
		else
	...
	elseif(frame.ORIENTATION == "RIGHT") then
		health:Point("TOPLEFT", frame, "TOPLEFT", frame.BORDER + frame.POWERBAR_OFFSET, -frame.BORDER - frame.CLASSBAR_YOFFSET);
		...
		elseif(frame.USE_POWERBAR_OFFSET) then
			health:Point("TOPLEFT", frame, "TOPLEFT", frame.BORDER+frame.POWERBAR_OFFSET, -frame.BORDER - frame.CLASSBAR_YOFFSET);
			health:Point("BOTTOMRIGHT", frame, "BOTTOMRIGHT", -(frame.PORTRAIT_WIDTH + frame.BORDER), frame.BORDER+frame.POWERBAR_OFFSET);
		elseif(frame.USE_MINI_POWERBAR) then
