		...
		if(db.threatStyle == "GLOW") then
			...
			if(frame.USE_POWERBAR_OFFSET) then
				if(frame.ORIENTATION == "LEFT") then
					...
					threat.glow:Point("BOTTOMRIGHT", frame.Health, "BOTTOMRIGHT", frame.SHADOW_SPACING, -frame.SHADOW_SPACING + frame.BORDER + frame.SPACING, -frame.SHADOW_SPACING - frame.BORDER - frame.SPACING);
				elseif(frame.ORIENTATION == "RIGHT") then
					...
					threat.glow:Point("BOTTOMLEFT", frame.Health, "BOTTOMLEFT", -frame.SHADOW_SPACING, -frame.SHADOW_SPACING -frame.BORDER - frame.SPACING, -frame.SHADOW_SPACING -frame.BORDER - frame.SPACING);
				else
