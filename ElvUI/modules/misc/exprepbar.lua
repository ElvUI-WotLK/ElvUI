...
function M:UpdateExpRepDimensions()
	...
	self.repBar.text:FontTemplate(E.LSM:Fetch('font', E.db.general.reputation.textFont), E.db.general.reputation.textSize, E.db.general.reputation.textOutline)
	self.expBar.text:FontTemplate(E.LSM:Fetch('font', E.db.general.experience.textFont), E.db.general.experience.textSize, E.db.general.experience.textOutline)
